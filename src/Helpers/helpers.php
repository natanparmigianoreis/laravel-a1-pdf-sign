...
use NatanParmigiano\LaravelA1PdfSign\Entities\EncryptedCertificate;
...
use NatanParmigiano\LaravelA1PdfSign\Sign\{ManagedCertificate, PDFSigner, ValidatePdfSignature};
